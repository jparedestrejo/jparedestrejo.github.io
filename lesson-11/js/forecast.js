...
var apiURL="https://api.openweathermap.org/data/2.5/forecast?"+codi+"&units=imperial&appid=07e8cdd414f51e368d4433fb5d72ef74";
fetch(apiURL)
  ...
  .then((jsObject) => {
    ...
    let fivedays = jsObject.list.filter(x => x.dt_txt.includes("18:00:00"));
